...
xhr.open(
    "GET",
    `https://newsapi.org/v2/everything?q=tech&from=${yesterday2}to=${today}&sortBy=publishedAt&apiKey=${apiKey}`,true
  );
  
// xhr.open(
//   "GET",
//   `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=f7a2b00e79c84745a994fef6c043c177`,true
// );
xhr.onload = function () {
  if (this.status === 200) {
